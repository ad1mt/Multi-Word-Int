...
- Bug fix - raise exceptions in add & subtract done at too low level -
			causes misleading error mess
...
POWER_INDEX_TABLE_X48	:array of INT_2W_U;
POWER_VALUES_TABLE_X48	:array of Multi_Int_X48;
POWER_VALUES_TABLE_MAX	:INT_2W_U;

(******************************************)
procedure	T_UBool.Init(v:UBool);
begin
if (v = UBool_TRUE) then B_Value:= UBool_TRUE
else if (v = UBool_FALSE) then B_Value:= UBool_FALSE
else B_Value:= UBool_UNDEF;
end;

function	T_UBool.ToStr:string;
begin
if (B_Value = UBool_TRUE) then Result:= 'TRUE'
else if (B_Value = UBool_FALSE) then Result:= 'FALSE'
else Result:= 'UNDEFINED';
end;

class operator T_UBool.implicit(v:UBool):T_UBool;
begin
Result.B_Value:= v;
end;

class operator T_UBool.implicit(v:T_UBool):UBool;
begin
Result:= v.B_Value;
end;

class operator T_UBool.implicit(v:Boolean):T_UBool;
begin
if v then Result.B_Value:= UBool_TRUE
else Result.B_Value:= UBool_FALSE;
end;

class operator T_UBool.implicit(v:T_UBool):Boolean;
begin
if (v.B_Value = UBool_TRUE) then Result:= TRUE
else Result:= FALSE;
end;

class operator T_UBool.equal(v1,v2:T_UBool):Boolean;
begin
if (v1.B_Value = v2.B_Value) then Result:= TRUE
else Result:= FALSE;
end;

class operator T_UBool.notequal(v1,v2:T_UBool):Boolean;
begin
if (v1.B_Value <> v2.B_Value) then Result:= TRUE
else Result:= FALSE;
end;
...
w:= nlz_words_X2(m);
if (w <= X2_max)
then Result:= nlz_bits(m.M_Value[X2_max-w]) + (w * INT_1W_SIZE)
...
var
	i,b,c,e		:INT_2W_U;
	M_Val		:array[0..X2_max] of INT_2W_U;
	Signeg,
	Zeroneg		:boolean;
begin
...
if Zeroneg then mi.Negative:= UBool_FALSE
else if Signeg then mi.Negative:= UBool_TRUE
else mi.Negative:= UBool_FALSE;
...
{******************************************}
class operator Multi_Int_X2.implicit(const v1:Multi_Int_X2):int8u;
var	R	:int8u;
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
Result:= int8u(v1.M_Value[0]);
end;


{******************************************}
class operator Multi_Int_X2.implicit(const v1:Multi_Int_X2):int8;
var	R	:int8;
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
Result:= int8(v1.M_Value[0]);
end;


(******************************************)
procedure Multi_Int_X2_to_hex(const v1:Multi_Int_X2; var v2:string; LZ:T_Leading_Zeros);
var
    s		:string = '';
	n		:int32u;
	M_Val	:array[0..X4_max] of INT_2W_U;
begin
if	(Not v1.Defined_flag)
then
	begin
...
if (LZ = Trim_Leading_Zeros) then Removeleadingchars(s,['0']);
if	(v1.Negative = UBool_TRUE) then s:='-' + s;
v2:=s;
end;


(******************************************)
function Multi_Int_X2.ToHex(const LZ:T_Leading_Zeros):string;
begin
...
if (v1.Negative = v2.Negative)
then Result.Negative:= UBool_FALSE
else Result.Negative:= UBool_TRUE;
end;
...
Result.Overflow_flag:=FALSE;
Result.Defined_flag:=TRUE;
Result.Negative.Init(UBool_UNDEF);
...
var
	M_Val	:array[0..X2_max] of INT_2W_S;
begin
Result.Overflow_flag:=FALSE;
Result.Defined_flag:=TRUE;
Result.Negative:=UBool_UNDEF;
...
if	(Result.Negative = UBool_UNDEF) then Result.Negative:= Neg;
end;
...
var
	M_Val	:array[0..X2_max_x2] of INT_2W_U;
	tv1,tv2	:INT_2W_U;
	i,j,k	:INT_1W_U;
begin
Result.Overflow_flag:=FALSE;
...
i:=0;
repeat M_Val[i]:= 0; INC(i); until (i > X2_max_x2);
...
if	(R.Negative = UBool_UNDEF) then
	if	(v1.Negative = v2.Negative)
	then R.Negative:= UBool_FALSE
	else R.Negative:=UBool_TRUE;
...
(******************************************)
class operator Multi_Int_X2.**(const v1:Multi_Int_X2;P:INT_1W_S):Multi_Int_X2;
...
w:= nlz_words_X3(m);
if (w <= X3_max)
then Result:= nlz_bits(m.M_Value[X3_max-w]) + (w * INT_1W_SIZE)
else Result:= (w * INT_1W_SIZE);
end;
...
var
	i,b,c,e		:INT_2W_U;
	M_Val		:array[0..X3_max] of INT_2W_U;
	Signeg,
	Zeroneg		:boolean;
begin
mi.Overflow_flag:=FALSE;
...
{******************************************}
class operator Multi_Int_X3.implicit(const v1:Multi_Int_X3):int8u;
(* var	R	:int8u; *)
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
{******************************************}
class operator Multi_Int_X3.implicit(const v1:Multi_Int_X3):int8;
(* var	R	:int8; *)
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
(******************************************)
procedure Multi_Int_X3_to_hex(const v1:Multi_Int_X3; var v2:string; LZ:T_Leading_Zeros);
var
    s		:string = '';
	n		:int32u;
	M_Val	:array[0..X3_max] of INT_2W_U;
...
(******************************************)
function Multi_Int_X3.ToHex(const LZ:T_Leading_Zeros):string;
begin
...
var
	M_Val	:array[0..X3_max] of INT_2W_S;
begin
Result.Overflow_flag:=FALSE;
Result.Defined_flag:=TRUE;
Result.Negative:=UBool_UNDEF;
...
var
	M_Val	:array[0..X3_max_x2] of INT_2W_U;
	tv1,tv2	:INT_2W_U;
	i,j,k	:INT_1W_U;
begin
Result.Overflow_flag:=FALSE;
...
i:=0;
repeat M_Val[i]:= 0; INC(i); until (i > X3_max_x2);
...
(******************************************)
class operator Multi_Int_X3.**(const v1:Multi_Int_X3;P:INT_1W_S):Multi_Int_X3;
...
w:= nlz_words_X4(m);
if (w <= X4_max)
then Result:= nlz_bits(m.M_Value[X4_max-w]) + (w * INT_1W_SIZE)
else Result:= (w * INT_1W_SIZE);
end;
...
{******************************************}
class operator Multi_Int_X4.implicit(const v1:Multi_Int_X4):int8u;
(* var	R	:int8u; *)
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
{******************************************}
class operator Multi_Int_X4.implicit(const v1:Multi_Int_X4):int8;
(* var	R	:int8u; *)
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
...
(******************************************)
procedure Multi_Int_X4_to_hex(const v1:Multi_Int_X4; var v2:string; LZ:T_Leading_Zeros);
var
    s		:string = '';
	n		:int32u;
	M_Val	:array[0..X4_max] of INT_2W_U;
...
(******************************************)
function Multi_Int_X4.ToHex(const LZ:T_Leading_Zeros):string;
begin
...
var
	M_Val	:array[0..X4_max] of INT_2W_S;
begin
Result.Overflow_flag:=FALSE;
Result.Defined_flag:=TRUE;
Result.Negative:=UBool_UNDEF;
...
var
	M_Val	:array[0..X4_max_x2] of INT_2W_U;
	tv1,tv2	:INT_2W_U;
	i,j,k	:INT_1W_U;
begin
Result.Overflow_flag:=FALSE;
...
i:=0;
repeat M_Val[i]:= 0; INC(i); until (i > X4_max_x2);
...
(******************************************)
class operator Multi_Int_X4.**(const v1:Multi_Int_X4;P:INT_1W_S):Multi_Int_X4;
...
(******************************************)
procedure Multi_Int_X48_to_hex(const v1:Multi_Int_X48; var v2:string; LZ:T_Leading_Zeros);
var
    s		:string = '';
	i,n		:INT_1W_S;
begin
...
(******************************************)
function Multi_Int_X48.ToHex(const LZ:T_Leading_Zeros):string;
begin
...
{******************************************}
class operator Multi_Int_X48.implicit(const v1:Multi_Int_X48):int8u;
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
or	(v1.Negative = UBool_TRUE)
...
{******************************************}
class operator Multi_Int_X48.implicit(const v1:Multi_Int_X48):int8;
begin
Overflow_Error:= FALSE;
if	(Not v1.Defined_flag)
or	(v1.Negative = UBool_TRUE)
...
(********************v1********************)
{
class operator Multi_Int_X48.**(const v1:Multi_Int_X48;P:INT_1W_S):Multi_Int_X48;
var
R,T					:Multi_Int_X48;
i,pi				:INT_1W_S;
...
(*----------------------------------*)
procedure build_power_values_table(const v1:Multi_Int_X48; const P:INT_2W_S);
var
TV,R	:Multi_Int_X48;
PI		:INT_2W_S;
...
and		(POWER_INDEX_TABLE_X48[PI] <= P)
and		(not TV.overflow)
do
	begin
...
POWER_VALUES_TABLE_MAX:= (PI - 1);
end;


(******************************************)
procedure build_power_index_table_X48;
var	N,PI:INT_2W_U;
begin
setlength(POWER_INDEX_TABLE_X48, POWER_TABLE_MAXLEN);
N:= 1;
PI:= 0;
while (PI <= POWER_TABLE_MAX) do
	begin
    POWER_INDEX_TABLE_X48[PI]:= N;
	Inc(PI);
	N:= (N * 2);
	end;
end;
...
PI:= POWER_TABLE_MAX;
while	(PI >= 1)
and		(POWER_INDEX_TABLE_X48[PI] > PT)
do
	Dec(PI);
end;
...
if  (P < 0) then
	...
	do
		...
		if	(TV.Negative = v1.Negative) then
			...
			R.Negative:= TRUE;
		TV:= R;
        PT:= (PT - POWER_INDEX_TABLE_X48[PI]);
		end;
	end;
Result:= R;

...
-	potetnial overflow bug in sqroot fixed
...
if NBits <= NBits_max then
	...
	v1.M_Value[Multi_XV_maxi]:= (v1.M_Value[Multi_XV_maxi] OR carry_bits_1);
...
i:=0;
repeat M_Val[i]:= 0; INC(i); until (i >= ss);

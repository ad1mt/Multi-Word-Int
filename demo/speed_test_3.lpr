...
MV_MUL_ITERATIONS	= 1000;
MV_SUB_ITERATIONS	= 10000;
...
MV_i:= (Multi_Int_XV_MAXINT >> (((MULTI_INT_XV_SIZE * 1) div 4) * 32));
MV_j:= (Multi_Int_XV_MAXINT >> (((MULTI_INT_XV_SIZE * 3) div 4) * 32));

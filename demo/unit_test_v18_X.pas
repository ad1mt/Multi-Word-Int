...
MULTI_DOUBLE_TYPE_MAXVAL	= '';
...
if	(Abs(Ub) >= (MULTI_REAL_TYPE_MAXVAL)) then
	begin
	Wb:= Abs(Ub);
	Ts:= Wb.tostr;
	n:= (length(Ts) div 2);
...
if	(Abs(Ub) >= MULTI_DOUBLE_TYPE_MAXVAL) then
	begin
	Wb:= Abs(Ub);
	Ts:= Wb.tostr;
	n:= (length(Ts) div 2);
...
repeat
	...
	or	(Mb.overflow)
	or	(Ab.overflow)
	then begin writeln('FAILED 1 !'); failed:= Multi_UBool_TRUE; end;
	...
	or	(Mb.overflow)
	or	(Ab.overflow)
	then begin writeln('FAILED 2 !'); failed:= Multi_UBool_TRUE; end;
...
if	(Ab <> Multi_MAXINT)
then begin writeln('FAILED 3b !'); failed:= Multi_UBool_TRUE; end;

if	(Mb <> Multi_MAXINT)
then begin writeln('FAILED 3c !'); failed:= Multi_UBool_TRUE; end;
...
repeat
	...
	or	(Mb.overflow)
	or	(Ab.overflow)
	then begin writeln('FAILED 4 !'); failed:= Multi_UBool_TRUE; end;
...
or	(Ab <> 1)
or	(Mb <> 1)
then begin writeln('FAILED 5 !'); failed:= Multi_UBool_TRUE; end;
...
{$ELSE}
	...
	{$ELSE}
		{$IFDEF CPU64}
			...
			Multi_Int_Set_XV_Limit(XV_SIZE + 1);	// the 64bit maximum size must be 18 otherwise large constants later must be changed
		{$ELSE} {$IFDEF CPU32}
		  	{$DEFINE 32BIT}
			XV_SIZE:= 35;
			Multi_Int_Initialisation(XV_SIZE);
			Multi_Int_Set_XV_Limit(XV_SIZE + 1);	// the 32bit maximum size must be 36 otherwise large constants later must be changed
		{$ELSE}
